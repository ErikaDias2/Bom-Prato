export const INITIAL_RECIPES_DATA = [
  {
    title: "Tapioca de Queijo e Presunto", category: "Café da Manhã", time_minutes: 10, difficulty: "Fácil", rating: 4.8, base_portions: 1,
    image_url: "https://i.pinimg.com/736x/3f/89/a3/3f89a3a90a096cc5d81cc269c476edbd.jpg",
    ingredients: JSON.stringify([{ amount: 3, unit: "colheres", name: "Goma de tapioca" }, { amount: 2, unit: "fatias", name: "Queijo mussarela" }, { amount: 2, unit: "fatias", name: "Presunto" }]),
    instructions: JSON.stringify([{ text: "Peneire a tapioca em uma frigideira média pré-aquecida.", timer_seconds: null }, { text: "Quando a massa unir, vire, adicione o queijo e o presunto, e dobre ao meio.", timer_seconds: 120 }]),
    suitable_for_prefs: "[]", contains_allergies: "[2]"
  },
  {
    title: "Panqueca Americana Fofinha", category: "Café da Manhã", time_minutes: 20, difficulty: "Fácil", rating: 4.9, base_portions: 4,
    image_url: "https://images.pexels.com/photos/7144309/pexels-photo-7144309.jpeg",
    ingredients: JSON.stringify([{ amount: 1, unit: "xícara", name: "Farinha de trigo" }, { amount: 1, unit: "xícara", name: "Leite" }, { amount: 1, unit: "unidade", name: "Ovo" }, { amount: 2, unit: "colheres", name: "Açúcar" }, { amount: 1, unit: "colher de chá", name: "Fermento em pó" }]),
    instructions: JSON.stringify([{ text: "Misture todos os ingredientes em uma tigela com um batedor (fouet) até ficar homogêneo.", timer_seconds: null }, { text: "Aqueça uma frigideira untada com manteiga e despeje pequenas conchas de massa.", timer_seconds: null }, { text: "Vire quando formar bolhas na superfície e doure do outro lado.", timer_seconds: 120 }]),
    suitable_for_prefs: "[1]", contains_allergies: "[1, 2]"
  },
  {
    title: "Pão na Chapa com Ovo Mexido", category: "Café da Manhã", time_minutes: 10, difficulty: "Fácil", rating: 4.8, base_portions: 1,
    image_url: "https://images.pexels.com/photos/34871730/pexels-photo-34871730.jpeg",
    ingredients: JSON.stringify([{ amount: 1, unit: "unidade", name: "Pão francês" }, { amount: 1, unit: "colher", name: "Manteiga" }, { amount: 2, unit: "unidades", name: "Ovos" }]),
    instructions: JSON.stringify([{ text: "Passe manteiga no pão cortado ao meio e doure em uma frigideira.", timer_seconds: 180 }, { text: "Na mesma frigideira, bata os ovos com uma pitada de sal e mexa até cozinhar.", timer_seconds: 120 }]),
    suitable_for_prefs: "[1]", contains_allergies: "[1, 2]"
  },
  {
    title: "Mingau de Aveia com Banana e Canela", category: "Café da Manhã", time_minutes: 10, difficulty: "Fácil", rating: 4.9, base_portions: 1,
    image_url: "https://images.pexels.com/photos/16144664/pexels-photo-16144664.jpeg",
    ingredients: JSON.stringify([{ amount: 1, unit: "xícara", name: "Leite" }, { amount: 3, unit: "colheres", name: "Aveia em flocos" }, { amount: 1, unit: "unidade", name: "Banana" }, { amount: 1, unit: "pitada", name: "Canela em pó" }]),
    instructions: JSON.stringify([{ text: "Em uma panela pequena, misture o leite e a aveia em fogo médio.", timer_seconds: null }, { text: "Mexa sem parar até engrossar (cerca de 5 minutos).", timer_seconds: 300 }, { text: "Sirva no prato e adicione a banana picada e a canela por cima.", timer_seconds: null }]),
    suitable_for_prefs: "[1]", contains_allergies: "[1, 2]"
  },
  {
    title: "Lasanha à Bolonhesa", category: "Almoço", time_minutes: 60, difficulty: "Média", rating: 4.8, base_portions: 6,
